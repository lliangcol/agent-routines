...
if ($Help) {
    ...
    Write-Host 'Checks bilingual doc pairing in docs/ and catalog consistency against SKILL.md.'
    exit 0
}
...
Write-Host 'validate-docs: ok (bilingual pairing and catalog consistency)'
